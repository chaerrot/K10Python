...
# 여러 개의 변수를 출력할 때는 콤마를 통해 구분한다.
print(r, g, b)

print("=======================")
print("정수형")
print("=======================")
# 파이썬은 변수 선언 시 별도의 데이터형을 붙이지 않는다.
x = 2
y = 4
z = 8

print("x / y", x / y) # 나누기. 항상 float형 결과를 반환한다.
print("x // y", x // y) #나누기. 소수 부분을 제거하므로 항상 int형의 결과를 반환한다.
print("X * y", x * y)
...
print(head * 3) # 문자열 반복하기(곱셉 기호 사용)
